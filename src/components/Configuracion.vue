<template>
  <div class="configuracion">
    ...
    <div class="md-layout md-gutter">
      <div
        class="md-layout-item md-xsmall-size-80 md-small-size-50 md-medium-size-40 md-large-size-40"
      >
        <h3 class="txt_opcion">Activar geolocalización</h3>
      </div>
      <div class="md-layout-item content_switch">
        <md-switch v-model="aceptGeoLoc" @change="solicitaPermisos"></md-switch>
      </div>
...
export default {
  ...
  methods: {
    solicitaPermisos() {
      if(this.aceptGeoLoc === true){
        this.checkPerms("switch");
      }
    },
    checkPerms(event){
    ...
    geo_error() {
      alert("Lo sentimos, la geolocalización NO está disponible.");
    },
    closeConfiguracion() {
