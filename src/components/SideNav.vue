      ...
      <div class="list md-scrollbar" @click="onClickSide2($event)">
        ...
        <md-toolbar class="md-transparent toolbar_user" md-elevation="0">
          <md-card v-show="false" class="md-primary card-info-user" md-theme="green-card">
            <md-card-header>
              <md-card-media>
                <img class="img_avatar_left" src="../assets/img/icon_user.png" alt="Avatar" />
              </md-card-media>

              <md-card-header-text class="header_title<">
        ...
        <div class="md-layout md-gutter">
          ...
          <div class="md-layout-item md-size-100">
            <md-list :md-expand-single="expandSingle">
              ...
              <md-list-item v-show="false" @click="logOut">
                <md-icon class="icon_side">phonelink_lock</md-icon>
...
<script>
import FormaDePago from "@/components/FormaDePago.vue";

export default {
  name: "SideNav",
  components:{
    //Configuracion: () => import("./Configuracion.vue"),
    FormaDePago: () => import("@/components/FormaDePago.vue")
  },
  props: {
    msg: String,
  ...
  created() {
    ...
    //this.clickMenu = this.showSideRight;
...
.toolbar_user > div > div{
  margin-bottom: 0 !important;
}

.toolbar_user > div > div > div{
  height: 40px;
