  ...
  <div class="home">
    ...
    <div>
      ...
      >
        ...
        >
          <router-link
            :to="{ path: '/detalles/' + $route.params.id, query: { categoria: slide.id, id_unidad: id_unidad, nombre_categoria: slide.nombre, img_categoria: slide.ubicacion} }"
          >
        ...
        >
          <div class="md-layout md-gutter">
            <div class="md-layout-item md-size-100">
              ...
              ></div>
              <h1 v-show="slide.visible" class="title_item_experiencia">
                {{ slide.descripcion }}
              </h1>
            </div>
          </div>
    ...
    <g id="Capa_2" data-name="Capa 2">
        <g id="Capa_1-2" data-name="Capa 1">
            <path class="white" d="M492,129.71a19.16,19.16,0,0,0-12.64-9L199.17,53.2a19,19,0,0,0-21.54,12.14L70.83,336.65l35.66,13,101.21-258,243.44,62.14c-15.2,47.13-51.38,145.51-86.06,237.11-30.24,79.92-47.63,107.29-80.7,112.88a.16.16,0,0,1-.08-.14C216.71,513.12,217.93,427,217.93,427L2.08,339.77C-13.26,437,61.44,460.37,61.44,460.37l158,71.75s24.74,11.77,51.56,10.57c72.32-1.71,97.74-54.22,129.58-138.36,46-121.59,92.71-257.83,93.17-259.28A18.89,18.89,0,0,0,492,129.71Z"/>
            <path class="white" d="M364.27,239.12A18.91,18.91,0,0,0,387.54,226a.33.33,0,0,1,0-.14,19,19,0,0,0-13.31-23.34h0L292,177.14a19,19,0,0,0-11.86,36.1q.92.3,1.86.51Z"/>
            <path class="white" d="M235.78,266.43a19,19,0,0,0,12,24l81.81,29.24a18.5,18.5,0,0,0,5.9,1,19,19,0,0,0,6.11-37l-81.78-29.18A19,19,0,0,0,235.78,266.43Z"/>
            <path class="white" d="M228.59,333.67A19,19,0,1,0,214,368.77h0a18.3,18.3,0,0,0,2.74.9l82,29.11a18.16,18.16,0,0,0,5.94,1,19,19,0,0,0,5.89-37Z"/>
            <path class="white" d="M225.55,155a20.72,20.72,0,0,1,21,20.44v0c0,11.3-9.43,20.45-21,20.45s-21.05-9.15-21.05-20.43S213.93,155,225.55,155Z"/>
            <path class="white" d="M195.78,231.06c11.63,0,21.05,9.16,21.05,20.45S207.41,272,195.78,272s-21.05-9.16-21.05-20.46S184.16,231.06,195.78,231.06Z"/>
            <path class="white" d="M164,309.49c11.63,0,21.06,9.17,21.06,20.48a21,21,0,1,1-21.52-20.47Z"/>
            <circle cx="402.78" cy="145.22" r="145.22" style="fill:#f58220"/>
            <text transform="translate(329.12 231.06)" style="font-size:253.79px;fill:#fffdfd;font-family:Avenir-Black,Avenir Black;font-weight:800">
                {{nPedidos}}
            </text>
        </g>
    </g>
...
export default {
  ...
  methods: {
    ...
    onAfterSlideChange(index) {
      console.log("s", index + "< " + this.experiencias.length);
    ...
    getWindowTam(e) {
      if (screen.availWidth < 400) {
        this.widthItem = 270;
        //this.widthItem = (screen.availWidth / 100) * 65;
    ...
    consultaExperiencias() {
      ...
      const baseURI = this.baseURL + "menudigital/index.php/experiencia/experiencia_marca";
      this.$http
        .get(
          baseURI,
          {
  ...
  mounted() {
    ...
    /*for (var i = 0; i < ca.length; i++) {
      ...
      if (c.indexOf(id_unidad_eks) === 0) {
        id_unidadCookie = c.substring(id_unidad_eks.length, c.length);
        //break;
      }
    }*/
...
s
    ...
    const baseURI = this.baseURL +  "menudigital/index.php/categoria";
    this.$http
      .get(
        baseURI,
        {
...
.btnMenuRight {
background: transparent linear-gradient(180deg, #2F2F30 0%, #262628 100%) 0% 0% no-repeat padding-box !important;
